...
A Next.js application using the Pages Router, structurally identical in layout to the sibling `labyrinth` package: `pages/`, `components/`, `sections/`, `modules/`, and per-scope Sass modules under `styles/`. Uses `animejs` for animation and `classnames` for conditional class composition.

**Path:** `libs/javascript/react/quest`
**Workspace name:** `lib.javascript.react.quest`

## Stack
- Next.js `^12.1.5` (Pages Router)
- React `^18.0.0`, React DOM `^18.0.0`
- `animejs ^3.2.1`, `classnames ^2.2.6`, `sass ^1.32.8`
