...
parser.add_argument(
    "-xy", "--dimensions", help="Maze dimentions", dest="dimensions", type=int, nargs=2
)
parser.add_argument(
    "-mt", "--type", help="Maze Type", dest="type", type=str, default="h"
)
...
if args.openfile:
    ...
    maze = Maze(
        build=(int(args.dimensions[0]), int(args.dimensions[1])), build_type=args.type
    )
else:
