...
with open(f"{decks_path}/kana-alphabet.txt") as vocab, open(
    f"{decks_path}/kana-alphabet.txt"
) as words, open("./particles-full.txt") as cards, open(
    "./particles-final.txt", "w"
) as final:
