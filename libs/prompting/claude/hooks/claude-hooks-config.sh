#!/usr/bin/env bash
# Example claude-code-hooks-config.sh - Project-specific Claude hooks configuration
#
# Copy this file to your project root as claude-code-hooks-config.sh and uncomment
