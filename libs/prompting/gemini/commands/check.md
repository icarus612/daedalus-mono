...
1. Re-read /home/icarus64/repos/daedalus-mono/libs/prompting/gemini/GEMINI.md RIGHT NOW
...
I will perform a deep analysis of validating this codebase against our exceptional standards.
...
- Run `~/gemini-code/hooks/smart-lint.sh` directly to see current state
- If ANY issues exist, they MUST be fixed before proceeding
- Check `~/gemini-code/hooks/violation-status.sh` if it exists
...
- `~/gemini-code/hooks/smart-lint.sh` for automatic detection
