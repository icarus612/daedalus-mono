...
**MANDATORY SEQUENCE:**
1. 🔍 **RESEARCH FIRST** - "I will now research the codebase and create a plan before implementing"
2. 📋 **PLAN** - Present a detailed plan and get it verified
3. ✅ **IMPLEMENT** - Execute with validation checkpoints

**YOU MUST SAY:** "I will now research the codebase and create a plan before implementing."

For complex tasks, say: "I will perform a deep analysis of this architecture before proposing a solution."

**USE MULTIPLE AGENTS** when the task has independent parts:
"I'll spawn agents to tackle different aspects of this problem"

Consult ../GEMINI.md IMMEDIATELY and follow it EXACTLY.
